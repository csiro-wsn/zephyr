...
# Search for revision and layour serparators
string(FIND "${BOARD}" "@" REVISION_SEPARATOR_INDEX)
string(FIND "${BOARD}" "%" LAYOUT_SEPARATOR_INDEX)

if((NOT (REVISION_SEPARATOR_INDEX EQUAL -1)) AND (NOT (REVISION_SEPARATOR_INDEX EQUAL -1)))
...
if(EXISTS ${BOARD_DIR}/layouts)
  ...
  set(BOARD_MESSAGE "${BOARD_MESSAGE}, Layout: ${BOARD_REVISION}")
elseif(NOT (${BOARD_REVISION} MATCHES "default"))
  message(WARNING "Board layout ${BOARD_REVISION} specified for ${BOARD}, \
                   but board has no layout folder so layout will be ignored.")
endif()
